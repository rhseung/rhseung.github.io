...
export const [themeClass, vars] = createTheme({
  color: {
    ...
    secondaryForeground: "oklch(0.141 0.005 285.823)",
    muted: "oklch(0.967 0.001 286.375)",
    mutedForeground: "oklch(0.456 0.004 285.823)",
    accent: "oklch(0.967 0.001 286.375)",
    accentForeground: "oklch(0.141 0.005 285.823)",
    destructive: "oklch(0.576 0.19 23.78)",
    destructiveForeground: "oklch(0.985 0 0)",
    border: "oklch(0.917 0.001 286.375)",
    input: "oklch(0.917 0.001 286.375)",
...
export const darkThemeClass = createTheme(vars, {
  color: {
    ...
    mutedForeground: "oklch(0.638 0.004 285.823)",
